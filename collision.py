...
def collide_mario(a):
    ...
    checkx1 = int((left_a + server.mario.mapx) // 50) - 1
    ...
    print("mario_right - " + str(right_a))
    print("mario_mapx - " + str(server.mario.mapx))
    if server.mario.cur_state == Character.JumpState:
        ...
        if right_a >= left_2 and left_a <= right_2 and (server.mymap.tile1[checkx2][checky1] != 0 and server.mymap.tile1[checkx2][checky1] != 1 and
        ...
        server.mymap.tile1[checkx2][checky1] != 12 and server.mymap.tile1[checkx2][checky1] != -1):
